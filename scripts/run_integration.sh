...
export DOCKER_DATABASE_URL="${DOCKER_DATABASE_URL:-postgresql+psycopg://postgres:postgres@db:5432/security_scanner}"
export JWT_SECRET_KEY="${JWT_SECRET_KEY:-ci-only-secret-change-in-production}"
